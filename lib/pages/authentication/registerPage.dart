            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 25),
                  MyTextField(onSubmitted:(e){signUp();},controller: emailController, hintText: 'Email', obscureText: false),
                  const SizedBox(height: 25),
                  MyTextField(onSubmitted:(e){signUp();},controller: passwordController, hintText: 'Password', obscureText: true),
                  const SizedBox(height: 25),
                  MyTextField(onSubmitted:(e){signUp();},controller: confirmPasswordController, hintText: 'Confirm Password', obscureText: true),
                  const SizedBox(height: 25),
                  SignInButton(
